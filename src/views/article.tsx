...
export default function ArticlePage({ article }: { article: Article }) {
  return (
    <article className="article-card w-full max-w-3xl mx-auto bg-[var(--card)] rounded-[28px] p-8 shadow-[0_8px_24px_rgba(0,0,0,0.5)] border border-[var(--border)]" style={{ fontFamily: "Inter, sans-serif" }}>
      {/* Header */}
